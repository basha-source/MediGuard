...
type Nav = StackNavigationProp<AuthStackParams, "Onboarding1">;
  ...
  return (
    <View style={s.root}>
      ...
      <View style={s.center}>
        ...
        <Text style={s.title}>Scan & Track Medicines</Text>
        <Text style={s.sub}>
          Scan barcodes to instantly add medicines to your inventory.
          Track stock, dosage and expiry all in one place.
        </Text>
      </View>
      <View style={s.bottom}>
        <View style={s.dots}>
        ...
        <TouchableOpacity style={s.btn} onPress={() => nav.navigate("Onboarding2")}>
